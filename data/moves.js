window.moves = {
  ...
  acupressure: {
    id: "acupressure",
    names: { en: "Acupressure", fr: "Acupression" },
    battleEffect: "Acupressure",
    type: "normal",
    damageFormula: "no_damage",
    power_points: 30
  },
  ...
  air_slash: {
    id: "air_slash",
    names: { en: "Air Slash", fr: "Lame d’Air" },
    battleEffect: null,
    type: "flying",
    damageFormula: "standard_damage",
    power_points: 20
  ...
  ancient_power: {
    id: "ancient_power",
    names: { en: "AncientPower", fr: "Pouvoir Antique" },
    battleEffect: null,
    type: "rock",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  aqua_ring: {
    id: "aqua_ring",
    names: { en: "Aqua Ring", fr: "Anneau Hydro" },
    battleEffect: "AquaRing",
    type: "water",
    damageFormula: "no_damage",
    power_points: 20
  },
  ...
  aqua_tail: {
    id: "aqua_tail",
    names: { en: "Aqua Tail", fr: "Hydro-Queue" },
    battleEffect: null,
    type: "water",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  assurance: {
    id: "assurance",
    names: { en: "Assurance", fr: "Assurance" },
    battleEffect: "Assurance",
    type: "dark",
    damageFormula: "standard_damage",
    power_points: 10
  },
  ...
  attack_order: {
    id: "attack_order",
    names: { en: "Attack Order", fr: "Appel Attaque" },
    battleEffect: "HighCritical",
    type: "bug",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  aura_sphere: {
    id: "aura_sphere",
    names: { en: "Aura Sphere", fr: "Aurasphère" },
    battleEffect: "CannotMiss",
    type: "fighting",
    damageFormula: "standard_damage",
    power_points: 20
  ...
  avalanche: {
    id: "avalanche",
    names: { en: "Avalanche", fr: "Avalanche" },
  ...
  blast_burn: {
    id: "blast_burn",
    names: { en: "Blast Burn", fr: "Rafale Feu" },
  ...
  bone_rush: {
    id: "bone_rush",
    names: { en: "Bone Rush", fr: "Charge Os" },
    battleEffect: null,
    type: "ground",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  bug_bite: {
    id: "bug_bite",
    names: { en: "Bug Bite", fr: "Piqûre" },
    battleEffect: "StealBerry",
    type: "bug",
    damageFormula: "standard_damage",
    power_points: 20
  },
  ...
  bullet_punch: {
    id: "bullet_punch",
    names: { en: "Bullet Punch", fr: "Pisto-Poing" },
    battleEffect: "Priority",
    type: "steel",
    damageFormula: "standard_damage",
    power_points: 30
  ...
  captivate: {
    id: "captivate",
    names: { en: "Captivate", fr: "Séduction" },
    battleEffect: "Captivate",
    type: "normal",
    damageFormula: "no_damage",
    power_points: 20
  },
  ...
  charge_beam: {
    id: "charge_beam",
    names: { en: "Charge Beam", fr: "Rayon Chargé" },
    battleEffect: null,
    type: "electric",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  close_combat: {
    id: "close_combat",
    names: { en: "Close Combat", fr: "Close Combat" },
    battleEffect: "CloseCombat",
    type: "fighting",
    damageFormula: "standard_damage",
    power_points: 5
  },
  ...
  conversion_2: {
    id: "conversion_2",
    names: { en: "Conversion2", fr: "Conversion 2" },
    battleEffect: "Conversion2",
    type: "normal",
    damageFormula: "no_damage",
    power_points: 30
  },
  ...
  copycat: {
    id: "copycat",
    names: { en: "Copycat", fr: "Photocopie" },
    battleEffect: "Copycat",
    type: "normal",
    damageFormula: "no_damage",
    power_points: 20
  },
  ...
  cosmic_power: {
    id: "cosmic_power",
    names: { en: "Cosmic Power", fr: "Force Cosmique" },
  ...
  cross_poison: {
    id: "cross_poison",
    names: { en: "Cross Poison", fr: "Poison Croix" },
  ...
  crush_claw: {
    id: "crush_claw",
    names: { en: "Crush Claw", fr: "Éclate Griffe" },
    battleEffect: null,
    type: "normal",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  crush_grip: {
    id: "crush_grip",
    names: { en: "Crush Grip", fr: "Presse" },
    battleEffect: "DamageByTargetHealth",
    type: "normal",
    damageFormula: "non_standard_damage",
    power_points: 5
  },
  ...
  dark_pulse: {
    id: "dark_pulse",
    names: { en: "Dark Pulse", fr: "Vibrobscur" },
    battleEffect: null,
    type: "dark",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  defend_order: {
    id: "defend_order",
    names: { en: "Defend Order", fr: "Appel Défense" },
    battleEffect: "BothDefenseUp1",
    type: "bug",
    damageFormula: "no_damage",
    power_points: 10
  ...
  destiny_bond: {
    id: "destiny_bond",
    names: { en: "Destiny Bond", fr: "Lien du Destin" },
  ...
  discharge: {
    id: "discharge",
    names: { en: "Discharge", fr: "Coup d’Jus" },
    battleEffect: null,
    type: "electric",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  double_hit: {
    id: "double_hit",
    names: { en: "Double Hit", fr: "Coup Double" },
    battleEffect: null,
    type: "normal",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  draco_meteor: {
    id: "draco_meteor",
    names: { en: "Draco Meteor", fr: "Draco-Météore" },
  ...
  dragon_breath: {
    id: "dragon_breath",
    names: { en: "DragonBreath", fr: "Draco-Souffle" },
    battleEffect: null,
    type: "dragon",
    damageFormula: "standard_damage",
    power_points: 20
  ...
  dragon_claw: {
    id: "dragon_claw",
    names: { en: "Dragon Claw", fr: "Draco-Griffe" },
    battleEffect: null,
    type: "dragon",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  dragon_pulse: {
    id: "dragon_pulse",
    names: { en: "Dragon Pulse", fr: "Draco-Choc" },
    battleEffect: null,
    type: "dragon",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  dragon_rush: {
    id: "dragon_rush",
    names: { en: "Dragon Rush", fr: "Draco-Charge" },
    battleEffect: null,
    type: "dragon",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  drain_punch: {
    id: "drain_punch",
    names: { en: "Drain Punch", fr: "Vampi-Poing" },
  ...
  dynamic_punch: {
    id: "dynamic_punch",
    names: { en: "DynamicPunch", fr: "Dynamo-Poing" },
    battleEffect: null,
    type: "fighting",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  earth_power: {
    id: "earth_power",
    names: { en: "Earth Power", fr: "Telluriforce" },
    battleEffect: null,
    type: "ground",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  egg_bomb: {
    id: "egg_bomb",
    names: { en: "Egg Bomb", fr: "Bombe Œuf" },
    battleEffect: null,
    type: "normal",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  energy_ball: {
    id: "energy_ball",
    names: { en: "Energy Ball", fr: "Éco-Sphère" },
    battleEffect: null,
    type: "grass",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  extreme_speed: {
    id: "extreme_speed",
    names: { en: "ExtremeSpeed", fr: "Vitesse Extrême" },
    battleEffect: "Priority",
    type: "normal",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  feather_dance: {
    id: "feather_dance",
    names: { en: "FeatherDance", fr: "Danse Plumes" },
    battleEffect: "TargetAttackDown2",
    type: "flying",
    damageFormula: "no_damage",
    power_points: 15
  ...
  fire_fang: {
    id: "fire_fang",
    names: { en: "Fire Fang", fr: "Crocs Feu" },
    battleEffect: null,
    type: "fire",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  fire_punch: {
    id: "fire_punch",
    names: { en: "Fire Punch", fr: "Poing Feu" },
    battleEffect: null,
    type: "fire",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  flare_blitz: {
    id: "flare_blitz",
    names: { en: "Flare Blitz", fr: "Boutefeu" },
    battleEffect: "FlareBlitz",
    type: "fire",
    damageFormula: "standard_damage",
    power_points: 15
  },
  ...
  flash_cannon: {
    id: "flash_cannon",
    names: { en: "Flash Cannon", fr: "Luminocanon" },
    battleEffect: null,
    type: "steel",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  focus_blast: {
    id: "focus_blast",
    names: { en: "Focus Blast", fr: "Exploforce" },
    battleEffect: null,
    type: "fighting",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  frenzy_plant: {
    id: "frenzy_plant",
    names: { en: "Frenzy Plant", fr: "Végé-Attaque" },
    battleEffect: "MustRecharge",
    type: "grass",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  gastro_acid: {
    id: "gastro_acid",
    names: { en: "Gastro Acid", fr: "Suc Digestif" },
    battleEffect: "GastroAcid",
    type: "poison",
    damageFormula: "no_damage",
    power_points: 10
  },
  ...
  giga_impact: {
    id: "giga_impact",
    names: { en: "Giga Impact", fr: "Giga Impact" },
    battleEffect: "MustRecharge",
    type: "normal",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  glare: {
    id: "glare",
    names: { en: "Glare", fr: "Regard Médusant" },
  ...
  grass_knot: {
    id: "grass_knot",
    names: { en: "Grass Knot", fr: "Nœud Herbe" },
  ...
  growl: {
    id: "growl",
    names: { en: "Growl", fr: "Rugissement" },
    battleEffect: "TargetAttackDown1",
    type: "normal",
    damageFormula: "no_damage",
    power_points: 40
  },
  ...
  gunk_shot: {
    id: "gunk_shot",
    names: { en: "Gunk Shot", fr: "Détricanon" },
    battleEffect: null,
    type: "poison",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  gyro_ball: {
    id: "gyro_ball",
    names: { en: "Gyro Ball", fr: "Gyroballe" },
    battleEffect: "GyroBall",
    type: "steel",
    damageFormula: "non_standard_damage",
    power_points: 5
  },
  ...
  hammer_arm: {
    id: "hammer_arm",
    names: { en: "Hammer Arm", fr: "Marto-Poing" },
    battleEffect: "HammerArm",
    type: "fighting",
    damageFormula: "standard_damage",
    power_points: 10
  },
  ...
  head_smash: {
    id: "head_smash",
    names: { en: "Head Smash", fr: "Fracass’Tête" },
    battleEffect: "12Recoil",
    type: "rock",
    damageFormula: "standard_damage",
    power_points: 5
  },
  ...
  heal_order: {
    id: "heal_order",
    names: { en: "Heal Order", fr: "Appel Soins" },
  ...
  hydro_cannon: {
    id: "hydro_cannon",
    names: { en: "Hydro Cannon", fr: "Hydroblast" },
    battleEffect: "MustRecharge",
    type: "water",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  ice_fang: {
    id: "ice_fang",
    names: { en: "Ice Fang", fr: "Crocs Givre" },
    battleEffect: null,
    type: "ice",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  ice_punch: {
    id: "ice_punch",
    names: { en: "Ice Punch", fr: "Poing Glace" },
    battleEffect: null,
    type: "ice",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  ice_shard: {
    id: "ice_shard",
    names: { en: "Ice Shard", fr: "Éclats Glace" },
    battleEffect: "Priority",
    type: "ice",
    damageFormula: "standard_damage",
    power_points: 30
  ...
  iron_head: {
    id: "iron_head",
    names: { en: "Iron Head", fr: "Tête de Fer" },
    battleEffect: null,
    type: "steel",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  last_resort: {
    id: "last_resort",
    names: { en: "Last Resort", fr: "Dernier Recours" },
    battleEffect: "LastResort",
    type: "normal",
    damageFormula: "standard_damage",
    power_points: 5
  },
  ...
  lava_plume: {
    id: "lava_plume",
    names: { en: "Lava Plume", fr: "Ébullilave" },
    battleEffect: null,
    type: "fire",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  leaf_storm: {
    id: "leaf_storm",
    names: { en: "Leaf Storm", fr: "Tempête Verte" },
    battleEffect: "DamageAndUserSpattackDown2",
    type: "grass",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  magical_leaf: {
    id: "magical_leaf",
    names: { en: "Magical Leaf", fr: "Feuille Magik" },
    battleEffect: "CannotMiss",
    type: "grass",
    damageFormula: "standard_damage",
    power_points: 20
  ...
  magma_storm: {
    id: "magma_storm",
    names: { en: "Magma Storm", fr: "Vortex Magma" },
    battleEffect: "Trap",
    type: "fire",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  magnet_bomb: {
    id: "magnet_bomb",
    names: { en: "Magnet Bomb", fr: "Bombe Aimant" },
    battleEffect: "CannotMiss",
    type: "steel",
    damageFormula: "standard_damage",
    power_points: 20
  ...
  magnet_rise: {
    id: "magnet_rise",
    names: { en: "Magnet Rise", fr: "Vol Magnétik" },
    battleEffect: "MagnetRise",
    type: "electric",
    damageFormula: "no_damage",
    power_points: 10
  },
  ...
  metal_burst: {
    id: "metal_burst",
    names: { en: "Metal Burst", fr: "Fulmifer" },
    battleEffect: "MetalBurst",
    type: "steel",
    damageFormula: "non_standard_damage",
    power_points: 10
  },
  ...
  mind_reader: {
    id: "mind_reader",
    names: { en: "Mind Reader", fr: "Lire-Esprit" },
    battleEffect: "LockOn",
    type: "normal",
    damageFormula: "no_damage",
    power_points: 40
  ...
  mirror_shot: {
    id: "mirror_shot",
    names: { en: "Mirror Shot", fr: "Miroi-Tir" },
    battleEffect: null,
    type: "steel",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  morning_sun: {
    id: "morning_sun",
    names: { en: "Morning Sun", fr: "Aurore" },
    battleEffect: "SunRecover",
    type: "normal",
    damageFormula: "no_damage",
    power_points: 5
  ...
  mud_bomb: {
    id: "mud_bomb",
    names: { en: "Mud Bomb", fr: "Boue-Bombe" },
    battleEffect: null,
    type: "ground",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  nasty_plot: {
    id: "nasty_plot",
    names: { en: "Nasty Plot", fr: "Machination" },
  ...
  night_shade: {
    id: "night_shade",
    names: { en: "Night Shade", fr: "Ombre Nocturne" },
  ...
  night_slash: {
    id: "night_slash",
    names: { en: "Night Slash", fr: "Tranche-Nuit" },
    battleEffect: "HighCritical",
    type: "dark",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  ominous_wind: {
    id: "ominous_wind",
    names: { en: "Ominous Wind", fr: "Vent Mauvais" },
    battleEffect: null,
    type: "ghost",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  payback: {
    id: "payback",
    names: { en: "Payback", fr: "Représailles" },
    battleEffect: "Payback",
    type: "dark",
    damageFormula: "standard_damage",
    power_points: 10
  },
  ...
  poison_fang: {
    id: "poison_fang",
    names: { en: "Poison Fang", fr: "Crochet Venin" },
    battleEffect: null,
    type: "poison",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  poison_jab: {
    id: "poison_jab",
    names: { en: "Poison Jab", fr: "Direct Toxik" },
    battleEffect: null,
    type: "poison",
    damageFormula: "standard_damage",
    power_points: 20
  ...
  poison_powder: {
    id: "poison_powder",
    names: { en: "PoisonPowder", fr: "Poudre Toxik" },
    battleEffect: "InflictPoison",
    type: "poison",
    damageFormula: "no_damage",
    power_points: 35
  },
  ...
  power_gem: {
    id: "power_gem",
    names: { en: "Power Gem", fr: "Rayon Gemme" },
    battleEffect: null,
    type: "rock",
    damageFormula: "standard_damage",
    power_points: 20
  ...
  power_trick: {
    id: "power_trick",
    names: { en: "Power Trick", fr: "Astuce Force" },
    battleEffect: "PowerTrick",
    type: "psychic",
    damageFormula: "no_damage",
    power_points: 10
  },
  ...
  power_whip: {
    id: "power_whip",
    names: { en: "Power Whip", fr: "Mégafouet" },
    battleEffect: null,
    type: "grass",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  psycho_cut: {
    id: "psycho_cut",
    names: { en: "Psycho Cut", fr: "Coupe Psycho" },
    battleEffect: "HighCritical",
    type: "psychic",
    damageFormula: "standard_damage",
    power_points: 20
  ...
  punishment: {
    id: "punishment",
    names: { en: "Punishment", fr: "Punition" },
    battleEffect: "Punishment",
    type: "dark",
    damageFormula: "non_standard_damage",
    power_points: 5
  },
  ...
  rock_smash: {
    id: "rock_smash",
    names: { en: "Rock Smash", fr: "Éclate-Roc" },
    battleEffect: null,
    type: "fighting",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  rock_wrecker: {
    id: "rock_wrecker",
    names: { en: "Rock Wrecker", fr: "Roc-Boulet" },
    battleEffect: "MustRecharge",
    type: "rock",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  roost: {
    id: "roost",
    names: { en: "Roost", fr: "Atterrissage" },
    battleEffect: "Roost",
    type: "flying",
    damageFormula: "no_damage",
    power_points: 5
  ...
  sandstorm: {
    id: "sandstorm",
    names: { en: "Sandstorm", fr: "Tempête de Sable" },
  ...
  seed_bomb: {
    id: "seed_bomb",
    names: { en: "Seed Bomb", fr: "Canon Graine" },
    battleEffect: null,
    type: "grass",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  shadow_claw: {
    id: "shadow_claw",
    names: { en: "Shadow Claw", fr: "Griffe Ombre" },
    battleEffect: "HighCritical",
    type: "ghost",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  shadow_sneak: {
    id: "shadow_sneak",
    names: { en: "Shadow Sneak", fr: "Ombre Portée" },
    battleEffect: "Priority",
    type: "ghost",
    damageFormula: "standard_damage",
    power_points: 30
  ...
  sludge_bomb: {
    id: "sludge_bomb",
    names: { en: "Sludge Bomb", fr: "Bombe Beurk" },
    battleEffect: null,
    type: "poison",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  splash: {
    id: "splash",
    names: { en: "Splash", fr: "Trempette" },
    battleEffect: "NoDamage",
    type: "normal",
    damageFormula: "no_damage",
    power_points: 40
  },
  ...
  stealth_rock: {
    id: "stealth_rock",
    names: { en: "Stealth Rock", fr: "Piège de Roc" },
    battleEffect: "StealthRock",
    type: "rock",
    damageFormula: "no_damage",
    power_points: 20
  },
  ...
  steel_wing: {
    id: "steel_wing",
    names: { en: "Steel Wing", fr: "Ailes d’Acier" },
    battleEffect: null,
    type: "steel",
    damageFormula: "standard_damage",
    power_points: 25
  ...
  stone_edge: {
    id: "stone_edge",
    names: { en: "Stone Edge", fr: "Lame de Roc" },
    battleEffect: "HighCritical",
    type: "rock",
    damageFormula: "standard_damage",
    power_points: 5
  ...
  sucker_punch: {
    id: "sucker_punch",
    names: { en: "Sucker Punch", fr: "Coup Bas" },
    battleEffect: "SuckerPunch",
    type: "dark",
    damageFormula: "standard_damage",
    power_points: 5
  },
  ...
  switcheroo: {
    id: "switcheroo",
    names: { en: "Switcheroo", fr: "Passe-Passe" },
  ...
  tailwind: {
    id: "tailwind",
    names: { en: "Tailwind", fr: "Vent Arrière" },
    battleEffect: "Tailwind",
    type: "flying",
    damageFormula: "no_damage",
    power_points: 30
  },
  ...
  thunder_fang: {
    id: "thunder_fang",
    names: { en: "Thunder Fang", fr: "Crocs Éclair" },
    battleEffect: null,
    type: "electric",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  thunder_shock: {
    id: "thunder_shock",
    names: { en: "ThunderShock", fr: "Éclair" },
    battleEffect: null,
    type: "electric",
    damageFormula: "standard_damage",
    power_points: 30
  ...
  toxic_spikes: {
    id: "toxic_spikes",
    names: { en: "Toxic Spikes", fr: "Pics Toxik" },
    battleEffect: "ToxicSpikes",
    type: "poison",
    damageFormula: "no_damage",
    power_points: 20
  },
  ...
  trick: {
    id: "trick",
    names: { en: "Trick", fr: "Tour de Magie" },
    battleEffect: "SwitchItems",
    type: "psychic",
    damageFormula: "no_damage",
    power_points: 10
  ...
  trick_room: {
    id: "trick_room",
    names: { en: "Trick Room", fr: "Distorsion" },
  ...
  trump_card: {
    id: "trump_card",
    names: { en: "Trump Card", fr: "Atout" },
    battleEffect: "TrumpCard",
    type: "normal",
    damageFormula: "non_standard_damage",
    power_points: 5
  },
  ...
  volt_tackle: {
    id: "volt_tackle",
    names: { en: "Volt Tackle", fr: "Électacle" },
    battleEffect: "VoltTackle",
    type: "electric",
    damageFormula: "standard_damage",
    power_points: 15
  },
  ...
  wake_up_slap: {
    id: "wake_up_slap",
    names: { en: "Wake-Up Slap", fr: "Réveil Forcé" },
    battleEffect: "WakeUpSlap",
    type: "fighting",
    damageFormula: "standard_damage",
    power_points: 10
  },
  ...
  water_sport: {
    id: "water_sport",
    names: { en: "Water Sport", fr: "Tourniquet" },
  ...
  weather_ball: {
    id: "weather_ball",
    names: { en: "Weather Ball", fr: "Ball’Météo" },
    battleEffect: null,
    type: "normal",
    damageFormula: "standard_damage",
    power_points: 10
  ...
  wing_attack: {
    id: "wing_attack",
    names: { en: "Wing Attack", fr: "Cru-Ailes" },
    battleEffect: null,
    type: "flying",
    damageFormula: "standard_damage",
    power_points: 35
  ...
  wood_hammer: {
    id: "wood_hammer",
    names: { en: "Wood Hammer", fr: "Martobois" },
    battleEffect: "13Recoil",
    type: "grass",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  worry_seed: {
    id: "worry_seed",
    names: { en: "Worry Seed", fr: "Soucigraine" },
    battleEffect: "WorrySeed",
    type: "grass",
    damageFormula: "no_damage",
    power_points: 10
  },
  ...
  wring_out: {
    id: "wring_out",
    names: { en: "Wring Out", fr: "Essorage" },
    battleEffect: "DamageByTargetHealth",
    type: "normal",
    damageFormula: "non_standard_damage",
    power_points: 5
  ...
  x_scissor: {
    id: "x_scissor",
    names: { en: "X-Scissor", fr: "Plaie Croix" },
    battleEffect: null,
    type: "bug",
    damageFormula: "standard_damage",
    power_points: 15
  ...
  zen_headbutt: {
    id: "zen_headbutt",
    names: { en: "Zen Headbutt", fr: "Psykoud’Boul" },
    battleEffect: null,
    type: "psychic",
    damageFormula: "standard_damage",
    power_points: 15
